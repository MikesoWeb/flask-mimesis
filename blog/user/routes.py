...
def account():
    ...
    if request.method == 'GET':
        ...
        path_one = os.path.join(os.getcwd(), f'blog/static/profile_pics/users/{user.username}')
        path_two = os.path.join(os.getcwd(), f'blog/static/profile_pics/users/{form.username.data}')
...
def delete_user(username):
    try:
        ...
        if user and user.id != 1:
            ...
            db.session.commit()
            full_path = os.path.join(os.getcwd(), 'blog/static', 'profile_pics', 'users', user.username)
